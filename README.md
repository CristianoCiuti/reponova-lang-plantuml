...
|---|---|
| Source code | [reponova-langs/packages/lang-plantuml](https://github.com/CristianoCiuti/reponova-langs/tree/main/packages/lang-plantuml) |
...
| npm package | [@reponova/lang-plantuml](https://www.npmjs.com/package/@reponova/lang-plantuml) (same package name, same install command) |

## Nothing changes for end users

The npm package `@reponova/lang-plantuml` is **still maintained and published** from the new monorepo. Install and usage are unchanged:
